...
| Context Length | 模型一次能看到的最大上下文。 | 长视频、长文档和 [Agent](<../08_Agent/基础概念/Agent.md>) 轨迹依赖长上下文。 |
...
| 论文 / 工作 | 解决了什么问题 | 提出了什么方法 | 还有什么不足 | 为什么读 | 链接 |
|-|-|-|-|-|-|
| [CLIP](<../02_大模型/模型细节/里程碑模型/CLIP.md>) | 视觉和语言缺少大规模对齐。 | 图文对比学习。 | 对视频时序和细粒度定位不足。 | 理解多模态对齐基础。 | [ICML 2021](https://proceedings.mlr.press/v139/radford21a.html) |
