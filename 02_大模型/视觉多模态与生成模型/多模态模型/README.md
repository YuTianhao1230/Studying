...
本目录整理视觉语言模型和视频理解相关概念，适合准备 VLM、图文对齐、多模态训练和多模态评测。

## 内容索引

| 文件 | 内容说明 |
| --- | --- |
| [CLIP 模型卡片](<../../模型细节/里程碑模型/CLIP.md>) | 图文对比学习、跨模态 embedding 和 zero-shot 迁移。 |
| [BLIP 与 BLIP-2 模型卡片](<../../模型细节/里程碑模型/BLIP与BLIP2.md>) | 图文理解与生成统一框架，以及视觉语言预训练方法。 |
