...
LSTM（Long Short-Term [Memory](<../../10_Agent/基础概念/Memory.md>)，长短期记忆网络）是 RNN 的改进版，通过引入记忆单元（cell state）和输入门、遗忘门、输出门三个门控机制，有选择地记住或丢弃信息，从而缓解标准 RNN 梯度消失、难以捕捉长距离依赖的问题。
