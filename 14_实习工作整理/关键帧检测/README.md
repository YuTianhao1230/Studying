...
3. 接着看 [数据飞轮与主动学习.md](<数据飞轮与主动学习.md>) 和 [并行DE与PE.md](<并行DE与PE.md>)，准备数据治理、规则沉淀和 prompt 追问。
4. 然后看 [CoT蒸馏与RL方案.md](<CoT蒸馏与RL方案.md>)，准备训练范式升级追问。
5. 最后看 [部署上线与容量评估.md](<部署上线与容量评估.md>)，准备工程落地和线上排查追问。
