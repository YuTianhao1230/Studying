...
本文整理 Joern 的代码属性图、查询方式、[静态分析](<../静态分析基础/静态分析.md>)能力，以及它在漏洞挖掘、代码数据构造和代码智能任务中的应用。
...
| 维度 | [CodeQL](<CodeQL.md>) (GitHub/Microsoft) | Joern (开源/ShiftLeft) |
| :--- | :--- | :--- |
...
*   **面试金句：** “我们利用 Joern 快速生成的 CPG 结构，作为我们多模态模型中的 **结构化感知器**。Joern 弥补了 [Transformer](<../../02_大模型/基础架构/Transformer.md>) 在长距离依赖捕捉上的不足。”
