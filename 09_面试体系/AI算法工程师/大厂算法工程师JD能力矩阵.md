...
- [大模型预训练与推理基础](<../../02_大模型/大模型预训练与推理基础.md>)
- [分布式训练通信与故障排查](<../../03_训练优化与对齐/训练框架与并行/分布式训练通信与故障排查.md>)
- [计算机视觉基础](<../../06_视觉多模态与生成模型/视觉基础/计算机视觉基础.md>)
- [高频算法模板](<../../07_Python与工程/算法刷题/高频算法模板.md>)
- [Python 工程实践](<../../07_Python与工程/Python工程实践.md>)
- [自我介绍与行为面试](<../综合面试题/自我介绍与行为面试.md>)
