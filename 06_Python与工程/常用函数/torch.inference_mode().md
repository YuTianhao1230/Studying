...
*   **`torch.inference_mode()`**：除了做 `no_grad` 做的事之外，它还关闭了 **视图追踪（View Tracking）** 和 **版本计数（Version [Counter](<../Python语法/Counter类.md>)）**。
...
2.  **更省内存**：生成的 Tensor 更加轻[量化](<../../05_推理部署与系统/推理工程/量化.md>)。
