...
• 组成：
  ...
  • 重复的卷积块（两个3×3卷积 + [ReLU](<../../03_训练优化与对齐/参数/常见激活函数.md>)激活函数）。
...
| [Attention](<../../02_大模型/基础架构/Self-Attention.md>) UNet| 添加注意力机制，关注重要区域                        | 小目标分割（如视网膜血管）    |
...
• 通用性：从ResNet到[Transformer](<../../02_大模型/基础架构/Transformer.md>)，跳跃连接已成为现代深度学习模型的标配设计。
